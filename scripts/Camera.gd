...
export(int, "Visible", "Hidden", "Captured, Confined") var mouse_mode = Input.MOUSE_MODE_VISIBLE#= Input.MOUSE_MODE_CAPTURED
...
export var max_speed = 5*Vector3(1.0, 1.0, 1.0)
